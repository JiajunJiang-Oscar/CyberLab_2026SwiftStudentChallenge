...
enum OnboardingStep: Int, CaseIterable {
    ...
    var description: String {
        ...
        case .selectFirstCard:
            return "Click the card box to choose your cards. Each mission requires 4 cards. Read the descriptions carefully and check the point cost before confirming your selection. Tap a selected card again to remove it from your choices."
        case .completed:
...
class InteractiveOnboardingManager: ObservableObject {
    ...
    // Check status
    @MainActor var hasCompleted: Bool {
